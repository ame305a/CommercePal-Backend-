...
public class BusinessOrderController {
    ...
    public ResponseEntity<?> businessCheckOut(@RequestBody String checkOut) {
                    ...
                    .ifPresentOrElse(order -> {
                        loanOrderRepository.findLoanOrderByOrderId(order.getOrderId())
                                .ifPresentOrElse(loanOrder -> {
                                    ...
                                    businessRepository.findBusinessByBusinessId(order.getBusinessId())
                                            .ifPresent(business -> {
                                                loanOrder.setCustomerPhone(business.getBusinessPhoneNumber());
                                                loanOrder.setCustomerEmail(business.getEmailAddress());
                                                customerName.set(business.getBusinessName());
                                            });
                        ...
                        businessRepository.findBusinessByBusinessIdAndEmailAddress(
                                ...
                                .ifPresentOrElse(business -> {
                                    ...
                                    responseMap.put("statusCode", ResponseCodes.REQUEST_FAILED)
                                            ...
                                            .put("statusMessage", "The Address does not belong to the business");
                                });
                    }, () -> {
                        responseMap.put("statusCode", ResponseCodes.REQUEST_FAILED)
                                .put("statusDescription", "The Order does not belong to the business")
                                .put("statusMessage", "The Order does not belong to the business");
                    });
        } catch (Exception e) {
